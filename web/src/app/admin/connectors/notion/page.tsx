      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for Chatdoc. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow Chatdoc to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the Chatdoc integration."
                ),
              })}
              initialValues={{
