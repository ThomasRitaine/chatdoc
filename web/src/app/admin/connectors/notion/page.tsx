      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for AthenaAI. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow AthenaAI to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the AthenaAI integration."
                ),
              })}
              initialValues={{
