            ...
            <Form>
              <div className="px-6 pb-6">
                ...
                <SelectorFormField
                  ...
                  subtext={
                    <>
                      If set to Citations, AthenaAIBot will respond with a direct
                      answer with inline citations. It will also provide links
                      to these cited documents below the answer. When in doubt,
                      choose this option.
                      <br />
                      <br />
                      If set to Quotes, AthenaAIBot will respond with a direct
                      answer as well as with quotes pulled from the context
                      documents to support that answer. AthenaAIBot will also
